                    ...
                    <div className="col-12">
                        <div className="card registerCard mt-5">
                            ...
                            <div className="card-header">
                                <h4 className="title text-center m-3">Registration To Search, Compare Apply To The Best School</h4>
                            </div>
                            <div className="card-body mb-1">
                                <form>
                                    <div className="px-2">
                                        ...
                                        <div class="input-group flex-nowrap my-4">
                                            <span class="input-group-text" style={{ "backgroundColor": "#fff", "border": "none" }}>+ 91</span>
