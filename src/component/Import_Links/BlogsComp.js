                ...
                <div>
                    ...
                    <div className="btn-content text-center m-3 mb-5">
                        <div className="ButtonGroup btn-group shadow-lg  bg-white rounded-pill">
                            <button type="button" value="Trending" className={`m-3 Trending ${trending ? "btnSelected" : ''}`} onClick={onSelected}>Trending</button>
                            <button type="button" value="Latest" className={`m-3 Latest ${selected ? "btnSelected" : ''}`} onClick={onSelected}>Latest</button>
                        </div>
                    </div>
                </div>
                <div className="row">
