...
import { faCalendar, faEnvelope, faUser, faClock } from '@fortawesome/free-solid-svg-icons';
...
const CardFilter = () => {
    ...
    const comapairSchoolFun =(id)=>{
          let seletingSchool = schoolData.map((ele)=>ele.schoolId === id);
          console.log(seletingSchool);
    }
...
{/* ####################################################################
    ...
    #################################################################### */}
            <div className='container cardFilter'>
                {console.log(compairSchool,"object")}
