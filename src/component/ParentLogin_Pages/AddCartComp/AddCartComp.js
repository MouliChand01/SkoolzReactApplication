                ...
                <div className='cartBody baseContainer'>
                    ...
                    <div className='row'>
                                            ...
                                            <div className='row'>
                                                ...
                                                <div className='col-8'>
                                                    <div className='rupesText'>
                                                        <i class="bi bi-currency-rupee" style={{ "color": "red", "fontSize": "30px" }} />0
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div className='col-lg-4'>
                            <div className='card leftcard p-2'>
                                <div className='me-auto'>Total :</div>
                                <div className='rupesText mt-2 mb-2'><i class="bi bi-currency-rupee" style={{ "color": "red", "fontSize": "30px" }} />0</div>
