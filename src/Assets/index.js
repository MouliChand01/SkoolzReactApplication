...
export const EventsAndWebinar = [
  {
    ...
    content: [
      {
        content:
          "The arts such as dance, music, and painting enrich the essence of our nation.",
      },
      {
        content:
          "Painting has not been far behind dance and music as elements of our culture over the years.",
      },
      {
        content:
          "Painting many aspects of Indian culture, history, and heritage has helped many painters establish themselves. Dancers have frequently been brought to life on canvas by both novice and seasoned artists.",
      },
      {
        content:
          "Debabrata Pal, at the extremely young age of 25 has accomplished what most others can only imagine. He is a master at adding life and colors to his storytelling.",
      },
      {
        contentHeader:
          "Painting has not been far behind dance and music as elements of our culture over the years.",
      ...
      {
        contentHeader: "About the guest speaker:",
      },
      {
        content:
          "Debabrata Pal is a renowned Visual Storyteller, Canvas Dancer, Handloom Designer, theatre actor and Odissi Dancer who has been recognised as one of the 50 Top Young Artistes of India. Recently received Rastriya Kala Snaman for his unique style work by Government of India.",
      },
      {
        content:
          "He has had the privileged to share the stage with Padma Vibhushan Guru Sonal Manshing, Padmashree Smt. Hema Malini, Padmashree Guru Ileana Chirtist, Padmashree Dr. Pt. Puru Dadheech, Padmashree Kailash Kher, recently share stage with legend actor Amitabh Bachchan, Padmashri Usha Uttap, performance at Jodhpur Palace & many other renowned artists.",
      },
      {
        content:
          "He has performed on many stages across India, and has presented his talk regarding 'Fine Art in Natyasastra' at various universities and institutions across India, USA, London",
      },
      {
        contentHeader: "About the Host:",
      },
    ],
  },
  {
