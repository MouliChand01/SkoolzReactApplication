...
import testimoni1 from '../Assets/Images/Punith_Gowda.png';
import testimoni2 from '../Assets/Images/Geetha__s.png';
import testimoni3 from '../Assets/Images/AnandMayi_Priyadarshini.png';
import testimoni4 from '../Assets/Images/deafulttestimonial.png';

import Award1 from '../Assets/Images/Startup-Certificate-Xergy.jpg'
import Award2 from '../Assets/Images/Best-Edutech-Award-2021.jpeg';
...
export const Testimonial = [
  ...
  },
  {
    ...
    parentName: "Shilpa",
    PostedBy: "Parent",
    parentImage: testimoni4,
    testimonialDis: '"My kid happened to attend many of the events conducted by Skoolz; they are fantastic. The science event was brilliant & also the Fish Tank event. "'
  ...
  },
  {
    ...
    PostedBy: "Parent",
    parentImage: testimoni4,
    testimonialDis: '"Thanks to Skoolz, we got admission to our child Abhi one of the good Preschools in Bengaluru. Swapna from Skoolz guided us from start to end and the Preschool is just 200 mts from our house. "'
...
export const Awards = [
  {
    id: 1,
    AwardName: "Best Edutech award was presented to Skoolz by Global Triumph Foundation",
    AwardImage: Award1,
    AwardsDis: ["Best Edutech award was presented to Skoolz by Global Triumph Foundation, Bengaluru, in association with MSME India.", "Date of Recognition: 11th April 2021", "Skoolz founder Mr Srinivas received the award."],
    Awardcontent: [{
      content: ["Best Edutech award was presented to Skoolz by Global Triumph Foundation, Bengaluru, in association with MSME India."]
    },
    {
      header: "Date of Recognition: 11th April 2021"
    },
    {
      header: "Skoolz founder Mr Srinivas received the award."
    },
    {
      splcontent: "Search, Compare, Book Appointment with the Best CBSE, ICSE, International & Pre-Schools in Bengaluru here"
    }]
  ...
  {
    id: 2,
    AwardName: "XergY Business Excellence Pvt Ltd (Skoolz) was recognized as a Startup by the Department for promoting industry and Internal Trade in Education Industry and Education Technology.",
    AwardImage: Award2,
    AwardsDis: ["XergY Business Excellence Pvt Ltd (Skoolz) was recognized as a Startup by the Department for promoting industry and Internal Trade in Education Industry and Education Technology."],
    Awardcontent: [{
      content: ["XergY Business Excellence Pvt Ltd (Skoolz) was recognized as a Startup by the Department for promoting industry and Internal Trade in Education Industry and Education Technology."]
    },
    {
      header: "Date of Recognition: 11th April 2021"
    },
